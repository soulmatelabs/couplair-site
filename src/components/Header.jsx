        ...
        <div className="flex justify-between items-center">
          ...
          <div className="bg-white/70 backdrop-blur-xl shadow-lg rounded-full px-4 py-2 pointer-events-auto ring-1 ring-white/50">
            <Link to="/" className="flex items-center gap-2">
              <img src={`${import.meta.env.BASE_URL}assets/images/logo-small.png`} alt="Couplair Logo" className="h-8 w-auto" />
          ...
          <nav className="bg-white/70 backdrop-blur-xl shadow-lg rounded-full px-2 py-2 sm:px-6 pointer-events-auto flex gap-6 items-center ring-1 ring-white/50">
            ...
            <button 
              ...
              className="bg-primary hover:bg-primary/90 text-white px-4 py-2 rounded-full text-sm font-semibold transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5"
            >
              Get the App
            </button>
          </nav>
